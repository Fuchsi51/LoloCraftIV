...
public class LoloWoodBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:lolo_wood")
	public static final Block block = null;

	public LoloWoodBlock(LolocraftivModElements instance) {
		super(instance, 55);
	}
