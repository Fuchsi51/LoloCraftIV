...
public class TestLeavesBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_leaves")
	public static final Block block = null;

	public TestLeavesBlock(LolocraftivModElements instance) {
		super(instance, 153);
	}
