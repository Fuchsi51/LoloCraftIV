...
public class AlgaeWoodBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:algae_wood")
	public static final Block block = null;

	public AlgaeWoodBlock(LolocraftivModElements instance) {
		super(instance, 202);
	}
