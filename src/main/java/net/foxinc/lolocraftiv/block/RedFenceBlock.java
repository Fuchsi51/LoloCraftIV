...
public class RedFenceBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_fence")
	public static final Block block = null;

	public RedFenceBlock(LolocraftivModElements instance) {
		super(instance, 7);
	}
