...
import net.foxinc.lolocraftiv.procedures.RedFenceWennBlockHinzugefugtProcedure;
...
public class RedFenceBlock extends LolocraftivModElements.ModElement {
	...
	public static class CustomBlock extends FenceBlock {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			RedFenceWennBlockHinzugefugtProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
