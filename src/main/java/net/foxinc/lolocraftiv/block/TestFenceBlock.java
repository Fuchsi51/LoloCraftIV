...
public class TestFenceBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_fence")
	public static final Block block = null;

	public TestFenceBlock(LolocraftivModElements instance) {
		super(instance, 156);
	}
