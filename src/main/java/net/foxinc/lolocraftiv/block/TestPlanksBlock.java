...
public class TestPlanksBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_planks")
	public static final Block block = null;

	public TestPlanksBlock(LolocraftivModElements instance) {
		super(instance, 152);
	}
