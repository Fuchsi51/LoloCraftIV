...
public class AlgaeLogBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:algae_log")
	public static final Block block = null;

	public AlgaeLogBlock(LolocraftivModElements instance) {
		super(instance, 203);
	}
