...
public class BadlandsPlanksBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_planks")
	public static final Block block = null;

	public BadlandsPlanksBlock(LolocraftivModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("badlands_planks");
		}
