...
public class TestSlabBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_slab")
	public static final Block block = null;

	public TestSlabBlock(LolocraftivModElements instance) {
		super(instance, 155);
	}
