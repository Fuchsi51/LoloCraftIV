...
public class BadlandsWoodBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_wood")
	public static final Block block = null;

	public BadlandsWoodBlock(LolocraftivModElements instance) {
		super(instance, 97);
	}
