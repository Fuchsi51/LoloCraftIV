...
public class TestLogBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_log")
	public static final Block block = null;

	public TestLogBlock(LolocraftivModElements instance) {
		super(instance, 151);
	}
