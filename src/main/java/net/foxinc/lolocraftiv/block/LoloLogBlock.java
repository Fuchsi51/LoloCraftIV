...
public class LoloLogBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:lolo_log")
	public static final Block block = null;

	public LoloLogBlock(LolocraftivModElements instance) {
		super(instance, 56);
	}
