...
public class RedcoalBlockBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:redcoal_block")
	public static final Block block = null;

	public RedcoalBlockBlock(LolocraftivModElements instance) {
		super(instance, 53);
	}
