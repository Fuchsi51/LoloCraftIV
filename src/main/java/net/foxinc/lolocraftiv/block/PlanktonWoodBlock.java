...
public class PlanktonWoodBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:plankton_wood")
	public static final Block block = null;

	public PlanktonWoodBlock(LolocraftivModElements instance) {
		super(instance, 180);
	}
