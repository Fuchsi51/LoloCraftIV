...
public class LoloFenceBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:lolo_fence")
	public static final Block block = null;

	public LoloFenceBlock(LolocraftivModElements instance) {
		super(instance, 61);
	}
