...
import net.foxinc.lolocraftiv.procedures.RedeffectwaterWennDerBlockVomSpielerZerstortWirdProcedure;
...
public class RedeffectwaterBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:redeffectwater")
	public static final Block block = null;

	public RedeffectwaterBlock(LolocraftivModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.CACTUS).sound(SoundType.SAND).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0));
			setRegistryName("redeffectwater");
		}
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(ParticleTypes.BUBBLE, d0, d1, d2, 0, 0, 0);
				}
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			RedeffectwaterWennDerBlockVomSpielerZerstortWirdProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
