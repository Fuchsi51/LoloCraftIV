...
public class RedPlanksBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_planks")
	public static final Block block = null;

	public RedPlanksBlock(LolocraftivModElements instance) {
		super(instance, 3);
	}
