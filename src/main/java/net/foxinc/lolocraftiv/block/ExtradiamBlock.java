...
public class ExtradiamBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:extradiam")
	public static final Block block = null;

	public ExtradiamBlock(LolocraftivModElements instance) {
		super(instance, 118);
	}
