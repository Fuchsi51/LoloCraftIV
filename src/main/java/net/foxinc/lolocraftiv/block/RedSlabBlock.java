...
public class RedSlabBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_slab")
	public static final Block block = null;

	public RedSlabBlock(LolocraftivModElements instance) {
		super(instance, 6);
	}
