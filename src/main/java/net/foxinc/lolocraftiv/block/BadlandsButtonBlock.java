...
public class BadlandsButtonBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_button")
	public static final Block block = null;

	public BadlandsButtonBlock(LolocraftivModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("badlands_button");
		}
