...
public class TestButtonBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_button")
	public static final Block block = null;

	public TestButtonBlock(LolocraftivModElements instance) {
		super(instance, 159);
	}
