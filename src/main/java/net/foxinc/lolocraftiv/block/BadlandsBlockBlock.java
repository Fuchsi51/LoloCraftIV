...
public class BadlandsBlockBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_block")
	public static final Block block = null;

	public BadlandsBlockBlock(LolocraftivModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("badlands_block");
		}
