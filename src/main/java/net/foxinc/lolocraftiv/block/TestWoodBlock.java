...
public class TestWoodBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_wood")
	public static final Block block = null;

	public TestWoodBlock(LolocraftivModElements instance) {
		super(instance, 150);
	}
