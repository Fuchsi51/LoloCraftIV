...
public class TestPressurePlateBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_pressure_plate")
	public static final Block block = null;

	public TestPressurePlateBlock(LolocraftivModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("test_pressure_plate");
		}
