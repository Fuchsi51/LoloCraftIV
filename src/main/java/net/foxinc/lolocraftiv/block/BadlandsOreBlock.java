...
public class BadlandsOreBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_ore")
	public static final Block block = null;

	public BadlandsOreBlock(LolocraftivModElements instance) {
		super(instance, 74);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lolocraftiv:badlands_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 7)).range(5).square()
					.func_242731_b(11);
			event.getRegistry().register(feature.setRegistryName("badlands_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lolocraftiv:badlands_ore"), configuredFeature);
		}
	}
