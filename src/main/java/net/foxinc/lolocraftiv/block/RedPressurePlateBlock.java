...
public class RedPressurePlateBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_pressure_plate")
	public static final Block block = null;

	public RedPressurePlateBlock(LolocraftivModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("red_pressure_plate");
		}
