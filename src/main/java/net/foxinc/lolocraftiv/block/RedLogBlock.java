...
public class RedLogBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_log")
	public static final Block block = null;

	public RedLogBlock(LolocraftivModElements instance) {
		super(instance, 1);
	}
