...
public class TestFenceGateBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_fence_gate")
	public static final Block block = null;

	public TestFenceGateBlock(LolocraftivModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("test_fence_gate");
		}
