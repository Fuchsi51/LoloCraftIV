...
public class LoloStairsBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:lolo_stairs")
	public static final Block block = null;

	public LoloStairsBlock(LolocraftivModElements instance) {
		super(instance, 59);
	}
