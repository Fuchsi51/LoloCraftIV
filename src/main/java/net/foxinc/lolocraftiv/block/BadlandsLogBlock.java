...
public class BadlandsLogBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_log")
	public static final Block block = null;

	public BadlandsLogBlock(LolocraftivModElements instance) {
		super(instance, 98);
	}
