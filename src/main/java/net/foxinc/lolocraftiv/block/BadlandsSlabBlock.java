...
public class BadlandsSlabBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_slab")
	public static final Block block = null;

	public BadlandsSlabBlock(LolocraftivModElements instance) {
		super(instance, 102);
	}
