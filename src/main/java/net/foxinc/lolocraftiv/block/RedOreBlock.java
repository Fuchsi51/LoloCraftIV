...
public class RedOreBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lolocraftiv:red_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 7)).range(15)
					.square().func_242731_b(6);
			event.getRegistry().register(feature.setRegistryName("red_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lolocraftiv:red_ore"), configuredFeature);
		}
	}
