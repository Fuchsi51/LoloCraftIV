...
import net.foxinc.lolocraftiv.procedures.BadlandsStairsWennEinBlockPlatziertWurdeVonProcedure;
...
public class BadlandsStairsBlock extends LolocraftivModElements.ModElement {
	...
	public static class CustomBlock extends StairsBlock {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			BadlandsStairsWennEinBlockPlatziertWurdeVonProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
