...
public class BadlandsStairsBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_stairs")
	public static final Block block = null;

	public BadlandsStairsBlock(LolocraftivModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("badlands_stairs");
		}
