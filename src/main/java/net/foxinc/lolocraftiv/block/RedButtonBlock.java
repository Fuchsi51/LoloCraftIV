...
public class RedButtonBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_button")
	public static final Block block = null;

	public RedButtonBlock(LolocraftivModElements instance) {
		super(instance, 10);
	}
