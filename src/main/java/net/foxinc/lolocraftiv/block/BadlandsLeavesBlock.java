...
public class BadlandsLeavesBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_leaves")
	public static final Block block = null;

	public BadlandsLeavesBlock(LolocraftivModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("badlands_leaves");
		}
