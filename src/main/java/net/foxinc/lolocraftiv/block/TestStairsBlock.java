...
public class TestStairsBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:test_stairs")
	public static final Block block = null;

	public TestStairsBlock(LolocraftivModElements instance) {
		super(instance, 154);
	}
