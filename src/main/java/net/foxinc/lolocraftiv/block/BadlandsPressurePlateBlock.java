...
public class BadlandsPressurePlateBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_pressure_plate")
	public static final Block block = null;

	public BadlandsPressurePlateBlock(LolocraftivModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("badlands_pressure_plate");
		}
