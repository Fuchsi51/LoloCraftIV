...
public class BadlandsFenceBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_fence")
	public static final Block block = null;

	public BadlandsFenceBlock(LolocraftivModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("badlands_fence");
		}
