...
public class RedStairsBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_stairs")
	public static final Block block = null;

	public RedStairsBlock(LolocraftivModElements instance) {
		super(instance, 5);
	}
