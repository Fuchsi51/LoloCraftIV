...
public class BadlandsFenceGateBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:badlands_fence_gate")
	public static final Block block = null;

	public BadlandsFenceGateBlock(LolocraftivModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("badlands_fence_gate");
		}
