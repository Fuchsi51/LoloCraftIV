...
public class RedLeavesBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_leaves")
	public static final Block block = null;

	public RedLeavesBlock(LolocraftivModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.PLANT).hardnessAndResistance(0.2f, 0.2f).setLightLevel(s -> 0));
			setRegistryName("red_leaves");
		}
