...
public class RedFenceGateBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_fence_gate")
	public static final Block block = null;

	public RedFenceGateBlock(LolocraftivModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("red_fence_gate");
		}
