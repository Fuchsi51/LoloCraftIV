...
import net.foxinc.lolocraftiv.procedures.RedFenceGateWennEinBlockPlatziertWurdeVonProcedure;
...
public class RedFenceGateBlock extends LolocraftivModElements.ModElement {
	...
	public static class CustomBlock extends FenceGateBlock {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			RedFenceGateWennEinBlockPlatziertWurdeVonProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
