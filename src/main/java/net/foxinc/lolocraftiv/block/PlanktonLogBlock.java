...
public class PlanktonLogBlock extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:plankton_log")
	public static final Block block = null;

	public PlanktonLogBlock(LolocraftivModElements instance) {
		super(instance, 181);
	}
