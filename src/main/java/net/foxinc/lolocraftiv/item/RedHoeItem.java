...
public class RedHoeItem extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_hoe")
	...
	public void initElements() {
		...
		}, 0, -3f, new Item.Properties().group(LoloCraftIVtoolsItemGroup.tab)) {
