...
public class WillimultitoolItem extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:willimultitool")
	public static final Item block = null;

	public WillimultitoolItem(LolocraftivModElements instance) {
		super(instance, 166);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("willimultitool"));
	}

	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(LoloCraftIVtoolsItemGroup.tab).maxDamage(2500));
		}
