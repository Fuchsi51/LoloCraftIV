...
import net.foxinc.lolocraftiv.procedures.RedArmorBodyTickEventredProcedure;
...
public class RedArmorItem extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("lolocraftiv:red_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("lolocraftiv:red_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("lolocraftiv:red_armor_boots")
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{7, 7, 8, 7}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(LoloCraftIVArmorItemGroup.tab)) {
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				RedArmorBodyTickEventredProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		}.setRegistryName("red_armor_boots"));
	}
