...
public class RedIngotItem extends LolocraftivModElements.ModElement {
	@ObjectHolder("lolocraftiv:red_ingot")
	public static final Item block = null;

	public RedIngotItem(LolocraftivModElements instance) {
		super(instance, 22);
	}
