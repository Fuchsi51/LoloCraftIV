...
public class LoloBiomBiome extends LolocraftivModElements.ModElement {

	public static Biome biome;

	public LoloBiomBiome(LolocraftivModElements instance) {
		super(instance, 76);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-3407872).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-6710887).withGrassColor(-6710887).build();
				...
				event.getRegistry().register(biome.setRegistryName("lolocraftiv:lolo_biom"));
			}
		}
