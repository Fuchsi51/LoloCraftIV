...
public class RedplainshillsBiome extends LolocraftivModElements.ModElement {
	public static Biome biome;

	public RedplainshillsBiome(LolocraftivModElements instance) {
		super(instance, 155);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.7999999999999999f)
						.scale(1.0999999999999999f).temperature(0.5f).downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("lolocraftiv:redplainshills"));
			}
		}
	}
