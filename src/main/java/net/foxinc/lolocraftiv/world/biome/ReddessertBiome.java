...
public class ReddessertBiome extends LolocraftivModElements.ModElement {
	...
	public ReddessertBiome(LolocraftivModElements instance) {
		super(instance, 21);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.AMBIENT, new MobSpawnInfo.Spawners(EntityType.ZOMBIE, 20, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("lolocraftiv:reddessert"));
			}
		}
	}
